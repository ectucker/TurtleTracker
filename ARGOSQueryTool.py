...
# a brace with a .format after the string will replace the zero with the first item in the list - jut a way of puttting values into a list.
# QUESTION: seems like it similar to the %s command....